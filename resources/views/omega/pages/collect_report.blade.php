...
@section('title', trans('sidebar.collect_report'))

@section('content')
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title text-bold"> @lang('sidebar.collect_report') </h3>
        </div>
        <div class="box-body">
            <div class="row">
                @if ($emp->level === 'N')
            ...
            <div class="col-md-12">
                <table id="bootstrap-data-table" class="nowrap table table-bordered table-striped table-hover table-responsive-xl" style="width: 100%">
                    <thead>
                    <tr>
                    ...
                    @foreach($writings as $writing)
                        <tr>
                            ...
                            <td class="text-right text-bold amount">{{money((int)($writing->total))}}</td>
                        </tr>
                    @endforeach
                    </tbody>
                </table>
...
@section('script')
    <script>
        ...
        function sumFields() {
            ...
            {{--$('#totAmount').text(money(totAmt));--}}
            {{--$('#totText').text("@lang('label.total')");--}}
        }
        ...
        {{--            //     $('#totAmount').text(money(response.totAmt));--}}
        {{--            // }--}}
        {{--        },--}}
        {{--        columns: [--}}
