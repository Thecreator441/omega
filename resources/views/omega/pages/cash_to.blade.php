...
@section('title', trans('sidebar.ctbank'))
...
@section('script')
    <script>
        ...
        $('#save').click(function () {
            ...
            if (amt === tot) {
                swal({
                        title: '@lang('sidebar.ctbank')',
                        text: '@lang('confirm.ctbank_text')',
                        type: 'info',
                ...
                swal({
                        title: '@lang('confirm.ctbank')',
                        text: '@lang('confirm.ctbankerror_text')',
                        type: 'error',
