    ...
    <div class="box">
        <div class="box-body">
            <form action="{{ url('acc_plan/store') }}" method="POST" role="form">
                <div class="box-header with-border">
                    <div class="col-md-8">
                        <div class="form-group">
                            <label for="code_plan" class="col-md-3 control-label">@if ($emp->lang == 'fr')
                                    Code du Plan @else Code Plan @endif</label>
                            <div class="col-md-3">
                                <select type="text" name="code_plan" id="code_plan" class="form-control select2">
                                    <option value=""></option>
                                </select>
                            </div>
                            <div class="col-md-6">
                                <input type="text" name="code_plan_name" id="code_plan_name" class="form-control" readonly>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="network" class="col-md-6 control-label">@if ($emp->lang == 'fr') Réseau @else Network @endif</label>
                            <div class="col-md-6">
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            <label for="acc_type" class="col-md-3 control-label">@if ($emp->lang == 'fr') Type de
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="acc_type" class="col-md-6 control-label">@if ($emp->lang == 'fr') Solde
                            ...
                            <div class="form-group">
                                <div class="checkbox">
                                    <label for="con_front_type">@if ($emp->lang == 'fr') Contrôle Saisie
                                        Frontoffice @else
                                            Control Frontoffice Typing @endif
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <select name="move_cash_acc" id="move_cash_acc"
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <select name="other1_cash_acc" id="other1_cash_acc"
                                                class="form-control select2">
                                            <option value=""></option>
                                        </select>
                                    </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <select name="other2_cash_acc" id="other2_cash_acc"
                                                class="form-control select2">
                                            <option value=""></option>
                                        </select>
                                    </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <select name="debtor_cash_acc" id="debtor_cash_acc"
                                                class="form-control select2">
                                            <option value=""></option>
                                        </select>
                                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="rate_amt" id="open_cash_amt" class="form-control" readonly></div>
                            </div>
                        </div>
                        <div class="col-md-8">
                            <div class="form-group">
                ...
                <div class="col-md-12">
                    <button type="button" id="delete" class="btn btn-sm bg-red pull-right btn-raised">
