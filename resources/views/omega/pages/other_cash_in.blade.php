...
@section('title', trans('sidebar.ocin'))

@section('content')
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title text-bold"> @lang('sidebar.ocin') </h3>
        </div>
...
{{--        </div>--}}
        <div class="box-body">
            <form action="{{ url('other_cash_in/store') }}" method="post" role="form" id="ocinForm">
                {{ csrf_field() }}
                <div class="col-md-3">
...
{{--                                        <div class="col-md-9">--}}
{{--                                            <select id="opera" class="form-control select2" disabled>--}}
{{--                                                @foreach($operas as $opera)--}}
{{--                                                    @if ($opera->opercode == 32)--}}
    ...
    <script>
        ...
        $(document).on('click', '#save', function () {
            if (parseInt(trimOver($('#diff').text(), null)) === 0) {
                swal({
                        title: '@lang('sidebar.ocin')',
                        text: '@lang('confirm.ocin_text')',
                        type: 'info',
                ...
                swal({
                        title: '@lang('sidebar.ocin')',
                        text: '@lang('confirm.ocinerror_text')',
                        type: 'error',
