                    ...
                    <div class="col-md-9" id="tableInput">
                        <div class="col-md-12">
                            <div class="row">
                                ...
                                {{--                            <div class="col-md-4 text-center text-blue text-bold">@lang('label.memaccs')</div>--}}
                                {{--                            <div class="col-md-4 bg-maroon-gradient"></div>--}}
...
@section('script')
    <script>
        ...
        $('#save').click(function () {
            ...
            if (cust !== '' && !isNaN(totbil) && totbil !== 0) {
                mySwal('@lang('sidebar.cin')', '@lang('confirm.cin_text')', '@lang('confirm.no')', '@lang('confirm.yes')', '#cinForm');
            } else {
                myOSwal('@lang('sidebar.cin')', '@lang('confirm.cinerror_text')', 'error');
            }
        });
