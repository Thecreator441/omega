...
@section('title', trans('sidebar.commis_report'))

@section('content')
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title text-bold"> @lang('sidebar.commis_report') </h3>
        </div>
        <div class="box-body">
            <div class="row">
                @if ($emp->level === 'N')
            ...
            <table id="bootstrap-data-table" class="table table-bordered table-striped table-hover table-responsive-xl">
                <thead>
                <tr>
