                    ...
                    <div class="col-md-12">
                        <table id="admin-data-table" class="table table-bordered table-striped table-hover table-responsive-xl">
                            ...
                            @foreach($main_menus_4 as $main_menu_4)
                                <tr>
                                    <td class="text-center"><i class="{{$main_menu_4->view_icon}}"></i></td>
                                    <td class="text-center">{{$main_menu_4->level}}</i></td>
                                    <td>@if($emp->lang == 'fr') {{ $main_menu_4->labelfr }} @else {{ $main_menu_4->labeleng }} @endif</td>
                                    <td>{{$main_menu_4->main_menu_3}}</td>
                                    <td>{{$main_menu_4->main_menu_2}}</td>
                                    <td>{{$main_menu_4->main_menu_1}}</td>
