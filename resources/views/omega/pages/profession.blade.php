...
@section('content')
    <div class="box box-info" id="newForm" style="display: none;">
        ...
        <div class="box-body">
            <form action="{{ route('profession/store') }}" method="post" role="form" id="counForm" class="needs-validation">
                {{ csrf_field() }}
                    ...
                    <div class="table-responsive">
                        <table id="admin-data-table" class="table table-bordered table-striped table-hover table-responsive-xl">
                            ...
                            @foreach($professions as $profession)
                                <tr>
                                    <td class="text-center">{{$profession->idprof}}</td>
                        ...
                        <form action="{{route('profession/delete')}}" method="post" role="form" id="delForm" style="display: none">
                            {{ csrf_field() }}
