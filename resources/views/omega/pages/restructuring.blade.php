...
@section('title', trans('sidebar.restruct'))
...
@section('content')
    <div class="box">
        ...
        <div class="box-body">
            <form action="{{ url('restructuring/store') }}" method="POST" role="form" id="resForm">
                {{csrf_field()}}
                <div class="box-header with-border">
                    <div class="col-md-2">
                        <div class="form-group">
                            <label>@lang('label.resby')</label>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <div class="radio">
                                <label for="byIntRate">@lang('label.monintrate')
                                    <input type="radio" name="resby" class="restruct" id="byIntRate" value="intrate">
                                </label>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            <div class="radio">
                                <label for="byNoInst">@lang('label.noinstal')
                                    <input type="radio" name="resby" class="restruct" id="byNoInst" value="install">
                                </label>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            <div class="radio">
                                <label for="byGrace">@lang('label.grace')
                                    <input type="radio" name="resby" class="restruct" id="byGrace" value="grace">
                                </label>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            <div class="radio">
                                <label for="byAll">@lang('label.all')
                                    <input type="radio" name="resby" class="restruct" id="byAll" value="all">
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <select name="amorti" id="amorti" class="form-control select2" disabled>
                                        <option></option>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <select name="period" id="period" class="form-control select2" disabled>
                                        <option></option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="tax_rate" id="tax_rate" class="form-control" disabled>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <input type="date" name="inst1" id="date" class="form-control" disabled>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-8">
...
@section('script')
    <script>
        $(document).ready(function () {
            $('#grace, #numb_inst').verifNumber();
            $('#tax_rate, #int_rate').verifTax();
        });

        $('#grace').change(function () {
            let date = new Date();
            date = date.addDays(parseInt($(this).val()));
        ...
        $('.restruct').click(function () {
            $(this).each(function () {
                if ($(this).is(':checked')) {
                    if ($(this).val() === 'intrate') {
                        $('#int_rate').attr('disabled', false);
                        $('#numb_inst').attr('disabled', true);
                        $('#grace').attr('disabled', true);
                    } else if ($(this).val() === 'install') {
                        $('#numb_inst').attr('disabled', false);
                        $('#grace').attr('disabled', true);
                        $('#int_rate').attr('disabled', true);
                    } else if ($(this).val() === 'grace') {
                        $('#grace').attr('disabled', false);
                        $('#int_rate').attr('disabled', true);
                        $('#numb_inst').attr('disabled', true);
        ...
        $('#save').click(function () {
            if (parseInt(trimOver($('#amoAmt').val(), null)) === parseInt(trimOver($('#amount').val(), null))) {
                swal({
                        title: '@lang('sidebar.restruct')',
                        text: '@lang('confirm.rest_text')',
                        type: 'info',
                ...
                swal({
                        title: '@lang('sidebar.restruct')',
                        text: '@lang('confirm.resterr_text')',
                        type: 'error',
...
@section('script')
    <script>
        $('#rest_amount').change(function () {
            if ($(this).is(':checked')) {
                $('#amount').removeAttr('disabled');
                $('#int_rate').attr('disabled', 'disabled');
                $('#numb_inst').attr('disabled', 'disabled');
                $('#diff_on_loan').attr('disabled', 'disabled');
            }
        });
        $('#rest_int_rate').change(function () {
            if ($(this).is(':checked')) {
                $('#int_rate').removeAttr('disabled');
                $('#amount').attr('disabled', 'disabled');
            }
        });
        $('#rest_instal').change(function () {
            if ($(this).is(':checked')) {
                $('#numb_inst').removeAttr('disabled');
                $('#amount').attr('disabled', 'disabled');
                $('#int_rate').attr('disabled', 'disabled');
            }
        });
        $('#rest_grace').change(function () {
            if ($(this).is(':checked')) {
                $('#diff_on_loan').removeAttr('disabled');
                $('#amount').attr('disabled', 'disabled');
                $('#int_rate').attr('disabled', 'disabled');
                $('#numb_inst').attr('disabled', 'disabled');
            }
