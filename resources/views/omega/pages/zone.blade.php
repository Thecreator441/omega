...
@section('content')
    <div class="box box-info" id="form" style="display: none;">
        ...
        <div class="box-body">
            <form action="{{ route('zone/store') }}" method="post" role="form" id="zoneForm" class="needs-validation">
                {{ csrf_field() }}
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="table-responsive">
                        ...
                        <form action="{{route('zone/delete')}}" method="post" role="form" id="delForm" style="display: none">
                            {{ csrf_field() }}
...
@section('script')
    <script>
        ...
        function submitForm() {
            ...
            mySwal("{{$title}}", text, '@lang('confirm.no')', '@lang('confirm.yes')', '#zoneForm');
        }
