...
@section('content')
    <div class="box box-info" id="newForm" style="display: none;">
        ...
        <div class="box-body">
            <form action="{{ route('division/store') }}" method="post" role="form" class="needs-validation" id="divForm">
                {{ csrf_field() }}
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="col-md-12">
                        ...
                        <form action="{{route('division/delete')}}" method="post" role="form" id="delForm" style="display: none">
                            {{ csrf_field() }}
...
@section('script')
    <script>
        ...
        function submitForm() {
            ...
            mySwal("{{$title}}", text, '@lang('confirm.no')', '@lang('confirm.yes')', '#divForm');
        }
