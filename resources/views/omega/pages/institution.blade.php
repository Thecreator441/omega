...
@section('content')
    <div class="box box-info" id="form" style="display: none;">
        ...
        <div class="box-body">
            <form action="{{ route('institution/store') }}" method="post" role="form" id="instForm" enctype="multipart/form-data" class="needs-validation">
                {{ csrf_field() }}
                            ...
                            <div class="form-group has-info">
                                ...
                                <div class="col-md-8">
                                    <select class="select2 form-control" name="input_tax" id="input_tax">
                                        <option value=""></option>
                                        <option value="Y" selected>@lang('label.yes')</option>
                                        <option value="N">@lang('label.no')</option>
                                    </select>
                                    <span class="help-block">@lang('placeholder.input_tax')</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-4 col-xs-6">
                            <div class="form-group has-info">
                                <label for="input_sms" class="col-md-4 control-label">@lang('label.input_sms')</label>
                                <div class="col-md-8">
                                    <select class="select2 form-control" name="input_sms" id="input_sms">
                                        <option value=""></option>
                                        <option value="Y" selected>@lang('label.yes')</option>
                                        <option value="N">@lang('label.no')</option>
                                    </select>
                                    <span class="help-block">@lang('placeholder.input_sms')</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="col-md-12">
                        ...
                        <form action="{{route('institution/delete')}}" method="post" role="form" id="delForm" style="display: none">
                            {{ csrf_field() }}
        ...
        function edit(idinstitute) {
            $.ajax({
                ...
                success: function (inst) {
                    $('#title').text('@lang('label.edit') ' + inst.abbr);
