...
@section('content')
    <div class="box">
        ...
        <form action="{{ url('registration/store') }}" id="regForm" method="post" role="form"
            ...
            {{ csrf_field() }}
            @if ($register == null)
                <input type="hidden" name="regnumb" id="regnumb" value="1">
            @else
                <input type="hidden" name="regnumb" id="regnumb" value="{{$register->regnumb + 1}}">
            @endif
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <input type="date" class="form-control" name="issuedate" id="idate">
                                </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="memtype" class="col-md-4 control-label">@lang('label.memtype')</label>
                        <div class="col-md-8">
                            <select class="form-control select2" id="memtype" name="memtype">
            ...
            <div class="" id="assoc">
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="assno" class="col-md-4 control-label">@lang('label.assnumb')</label>
                            <div class="col-md-8">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="asstype" class="col-md-5 control-label">@lang('label.assoctype')</label>
                            <div class="col-md-7">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="assmemno" class="col-md-5 control-label">@lang('label.assmemno')</label>
                            <div class="col-md-7">
            ...
            <div class="" id="enterp">
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="taxpaynumb" class="col-md-4 control-label">@lang('label.taxpayno')</label>
                            <div class="col-md-8">
...
@section('script')
    <script>
        $(document).ready(function () {
            $('#nic, #cnpsnumb, #witnes_nic, .bene_reg, #assno, #assmemno, #nic, #phone1, #phone2, #taxpaynumb, #comregis, #regime').verifNumber();
        ...
        $('#save').click(function () {
            ...
            if (sum === 100) {
                ...
                swal({
                        title: '@lang('confirm.memreg_header')',
                        text: '@lang('confirm.memregerror_text')',
                        type: 'error',
