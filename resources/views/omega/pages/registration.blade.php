...
@section('title', trans('sidebar.registration'))
            ...
            <form action="{{ url('registration/store') }}" id="regForm" method="post" role="form"
                ...
                <div id="fillform">
                    @if ($emp->collector !== null)
                            ...
                            <div class="col-md-4 col-xs-12">
                                <div class="col-md-12 col-xs-6">
                                    <div class="form-group" style="height: 100px; width: 100%;">
                                        <a><img id="pic" onclick="chooseFile('pic')" src="" alt="@lang('placeholder.uppic')" style="height: 100px; width: 100%;" class="img-bordered-sm img-responsive"/></a>
                                        <div style="height: 0; overflow: hidden"><input type="file" name="profile" accept='image/*' id="inpic"/></div>
                                    </div>
                                </div>
                                <div class="col-md-12 col-xs-6">
                                    <div class="form-group" style="height: 60px; width: 100%;">
                                        <a><img id="sign" onclick="chooseFile('sign')" src="" alt="@lang('placeholder.upsign')" style="height: 60px; width: 100%;" class="img-bordered-sm img-responsive"/></a>
                        ...
                        <div class="box-header with-border">
                            {{--                        <h4 class="box-title text-bold">@lang('label.nxtofkin') <span class="text-red text-bold">*</span></h4>--}}
                            ...
                            <table class="table table-hover table-bordered table-condensed table-responsive" id="memberInput">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="bene_name[]" class="reg" required>
                                        {{--                                    <span class="help-block">@lang('placeholder.name')</span>--}}
                                    </td>
                                    <td>
                                        <input type="text" name="bene_relate[]" class="reg" required>
                                        {{--                                    <span class="help-block">@lang('placeholder.rela')</span>--}}
                                    </td>
                                    <td>
                                        <input type="text" name="bene_ratio[]" class="reg bene_reg text-right text-bold" required>
                                        {{--                                    <span class="help-block">@lang('placeholder.prop')</span>--}}
                                    </td>
                                </tr>
                                </tbody>
                                <tfoot>
                                <tr>
                                    <th colspan="3" class="text-right">@lang('label.remain')</th>
                        ...
                        <div id="moral" style="display: none">
                            <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-xs-12">
                                            <div class="form-group has-error">
                                                ...
                                                <div class="col-md-3 col-xs-7">
                                                    <input type="date" class="form-control" name="dob" id="date creadate" required>
                                                    <span class="help-block">@lang('placeholder.dob')</span>
                                                </div>
                                                <label for="pob" class="col-md-1 col-xs-3 control-label">@lang('label.at') <span class="text-red text-bold">*</span></label>
                                                <div class="col-md-6 col-xs-9">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-xs-6">
                                            <div class="form-group has-error">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="text" class="form-control" name="liveper" id="liveper" required>
                                ...
                                <div class="col-md-4 col-xs-12">
                                    ...
                                    <div id="assocsign">
                                        <div class="col-md-4 col-xs-6">
                                            <div class="form-group" style="height: 60px; width: 100%;">
                                                <a><img id="sign1" onclick="chooseFile('sign1')" src="" alt="@lang('placeholder.upsign')" style="height: 60px; width: 100%;" class="img-bordered-sm img-responsive"/></a>
                                                <div style="height: 0; overflow: hidden"><input type="file" name="signature1" id="insign1"/></div>
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-xs-6">
                                            <div class="form-group" style="height: 60px; width: 100%;">
                                                <a><img id="sign2" onclick="chooseFile('sign2')" src="" alt="@lang('placeholder.upsign')" style="height: 60px; width: 100%;" class="img-bordered-sm img-responsive"/></a>
                                                <div style="height: 0; overflow: hidden"><input type="file" name="signature2" id="insign2"/></div>
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-xs-6">
                                            <div class="form-group" style="height: 60px; width: 100%;">
                                                <a><img id="sign3" onclick="chooseFile('sign3')" src="" alt="@lang('placeholder.upsign')" style="height: 60px; width: 100%;" class="img-bordered-sm img-responsive"/></a>
                                                <div style="height: 0; overflow: hidden"><input type="file" name="signature3" id="insign3"/></div>
                                            </div>
                                        </div>
                                    </div>

                                    <div id="entersign" style="display: none">
                                        <div class="col-md-12 col-xs-6">
                                            <div class="form-group" style="height: 60px; width: 100%;">
                                                <a><img id="sign" onclick="chooseFile('sign')" src="" alt="@lang('placeholder.upsign')" style="height: 60px; width: 100%;" class="img-bordered-sm img-responsive"/></a>
                                                <div style="height: 0; overflow: hidden"><input type="file" name="signature" accept='image/*' id="insign"/></div>
                            ...
                            <div id="assoc">
                                <div class="row">
                                    <div class="col-md-6 col-xs-6">
                                        <div class="form-group has-error">
                                            <label for="assno" class="col-md-4 control-label">@lang('label.assnumb') <span class="text-bold text-red">*</span></label>
                                            <div class="col-md-8">
                        ...
                        <div class="box-header with-border">
                            ...
                            <div class="col-md-12">
                                <div class="col-md-8 col-xs-12">
                                    <div class="form-group has-error">
                                        <label for="witnes_name" class="col-md-4 control-label">@lang('label.nam&sur') <span class="text-red text-bold">*</span></label>
                                        <div class="col-md-8">
                ...
                @foreach($clients as $client)
                    <tr>
                        <td class="text-center">
                            @if ($emp->collector !== null)
                                {{pad($client->coll_memnumb, 6)}}
                            @else
                                {{pad($client->regnumb, 6)}}
                            @endif
                        </td>
                        ...
                        <td class="text-center">
                            @if ($emp->collector !== null)
                                <button type="button" class="btn btn-info bg-aqua btn-sm fa fa-edit" onclick="edit('{{$client->idcollect_mem}}')"></button>
                            @else
                                <button type="button" class="btn btn-info bg-aqua btn-sm fa fa-edit" onclick="edit('{{$client->idregister}}')"></button>
                            @endif
                        </td>
                    </tr>
                @endforeach
...
@section('script')
    <script>
            ...
            function edit(idcustomer) {
                $.ajax({
                    ...
                    success: function (customer) {
                        $('#title').text('@lang('label.edit') ' + customer.name);

                        $('#idinstitute').val(customer.idcollect_mem);
                        $('#name').val(customer.name);
                        $('#surname').val(customer.surname);
                        $('#status').val(customer.status).select2();
                        $('#gender').val(customer.gender).select2();
                        $('#date').val(customer.dob);
                        $('#pob').val(customer.pob);
                        $('#cnpsnumb').val(customer.cnpsnumb);
                        $('#profession').val(customer.profession).select2();
                        $('#phone1').val(customer.phone1);
                        $('#phone2').val(customer.phone2);
                        $('#email').val(customer.email);
                        $('#nic_type').val(customer.nic_type).select2();
                        $('#nic').val(customer.nic);
                        $('#idate').val(customer.issuedate);
                        $('#issueplace').val(customer.issueplace);
                        $('#country').val(customer.country).select2();
                        $('#region').val(customer.region).select2();
                        $('#regorigin').val(customer.regorigin).select2();
                        $('#division').val(customer.division).select2();
                        $('#subdiv').val(customer.subdivision).select2();
                        $('#town').val(customer.town).select2();
                        $('#address').val(customer.address);
                        $('#quarter').val(customer.quarter);
        ...
        function submitForm() {
            let id = parseInt($('#idinstitute').val());
            ...
            if (sum === 100) {
                mySwal('@lang('sidebar.registration')', text, '@lang('confirm.no')', '@lang('confirm.yes')', '#regForm');
            } else {
                myOSwal('@lang('sidebar.registration')', text, 'error');
            }
        }
