...
@section('title', trans('sidebar.cashtocash'))

@section('content')
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title text-bold"> @lang('sidebar.cashtocash') </h3>
        </div>
        ...
        {{--        </div>--}}
        <div class="box-body">
            <form action="{{ url('cashtocash/store') }}" method="post" role="form" id="cashToCashForm">
                {{ csrf_field() }}
                <div class="box-header with-border">
    ...
    <script>
        ...
        $('#save').click(function () {
            ...
            if (!isNaN(cash) && !isNaN(tot)) {
                swal({
                        title: '@lang('sidebar.cashtocash')',
                        text: '@lang('confirm.cashtocash_text')',
                        type: 'info',
                ...
                swal({
                        title: '@lang('sidebar.cashtocash')',
                        text: '@lang('confirm.cashtocasherror_text')',
                        type: 'error',
