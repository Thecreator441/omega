...
'admin/network', 'admin/zone', 'admin/institution', 'admin/branch', 'cash', 'bank', 'acc_plan', 'mem_setting', 'operation', 'admin/acctype', 'admin/loantype', 'admin/loanpur', 'admin/privilege']) }}">
    ...
    <ul class="treeview-menu">
        <li class="treeview {{ active(['admin/currency', 'admin/money', 'admin/country', 'admin/region', 'admin/division',
        'admin/subdivision', 'admin/network', 'admin/zone', 'admin/institution', 'acc_plan', 'admin/privilege']) }}">
            <a href="">
            ...
            <ul class="treeview-menu">
                ...
                <li class="{{ active('admin/division') }}"><a href="{{ url('admin/division') }}"><i
                            class="fa fa-gear"></i>@if($emp->lang == 'fr') Département @else Division @endif</a></li>
                ...
                <li class="{{ active('acc_plan') }}"><a href="{{ url('acc_plan') }}"><i class="fa fa-gear"></i>
                        @if($emp->lang == 'fr') Plan Comptable @else Accounting Plan @endif</a>
                </li>
