...
@section('title', trans('sidebar.branch'))
...
@section('content')
    <div class="box" id="form" style="display: block;">
        ...
        <div class="box-body">
            <form action="{{ route('admin/branch/store') }}" method="post" role="form" id="branForm" class="needs-validation">
                {{ csrf_field() }}
    ...
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title text-bold"> @lang('sidebar.branch') </h3>
            <div class="box-tools pull-right">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="col-md-12">
                        ...
                        <form action="{{route('admin/branch/delete')}}" method="post" role="form" id="delForm" style="display: none">
                            {{ csrf_field() }}
...
@section('script')
    <script>
        ...
        function submitForm() {
            ...
            mySwal('@lang('sidebar.branch')', text, '@lang('confirm.no')', '@lang('confirm.yes')', '#branForm');
        }
