...
@section('title', trans('sidebar.device'))
...
@section('content')
    <div class="box box-info" id="form" style="display: none;">
        ...
        <div class="box-body">
            <form action="{{ route('admin/device/store') }}" method="post" class="needs-validation" role="form" id="instForm" enctype="multipart/form-data">
                {{ csrf_field() }}
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-6">
                            <div class="form-group has-error">
                                ...
                                <div class="col-md-8">
                                    <input class="form-control" id="os_version" name="os_version" required>
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <div class="form-group has-info">
                                ...
                                <div class="col-md-8">
                                    <input class="form-control" id="dev_model" name="dev_model">
    ...
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title text-bold"> @lang('sidebar.device') </h3>
            <div class="box-tools pull-right">
        ...
        <div class="box-body">
            ...
            <form action="{{route('admin/device/delete')}}" method="post" role="form" id="delForm" style="display: none">
                {{ csrf_field() }}
                <input type="hidden" name="institute" id="institute" value="">
            </form>
            <form action="{{route('admin/device/blun')}}" method="post" role="form" id="blunForm" style="display: none">
                {{ csrf_field() }}
...
@section('script')
    <script>
        ...
        function edit(iddevice) {
            $.ajax({
                ...
                success: function (device) {
                    ...
                    $('#os_version').val(device.os_version);
        ...
        function submitForm() {
            ...
            mySwal('@lang('sidebar.device')', text, '@lang('confirm.no')', '@lang('confirm.yes')', '#instForm');
        }
