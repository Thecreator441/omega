...
@section('title', trans('sidebar.network'))
...
@section('content')
    <div class="box" id="form" style="display: none;">
        ...
        <div class="box-body">
            <form action="{{ route('admin/network/store') }}" method="post" role="form" id="netForm" class="needs-validation">
                {{ csrf_field() }}
...
{{--                    </div>--}}
    ...
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title text-bold"> @lang('sidebar.network') </h3>
            <div class="box-tools pull-right">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="col-md-12">
                        ...
                        <form action="{{route('admin/network/delete')}}" method="post" role="form" id="delForm" style="display: none">
                            {{ csrf_field() }}
...
@section('script')
    <script>
        ...
        function edit(idnetwork) {
            $.ajax({
                ...
                success: function (network) {
                    $('#title').text('@lang('label.edit') ' + network.name);
        ...
        function submitForm() {
            ...
            mySwal('@lang('sidebar.network')', text, '@lang('confirm.no')', '@lang('confirm.yes')', '#netForm');
        }
