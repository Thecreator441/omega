...
@section('title', trans('sidebar.town'))
...
@section('content')
    <div class="box box-info" id="newForm" style="display: none;">
        ...
        <div class="box-body">
            <form action="{{ route('admin/town/store') }}" method="post" role="form" class="needs-validation" id="townForm">
                {{ csrf_field() }}
    ...
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title text-bold">@lang('sidebar.town')</h3>
            <div class="box-tools pull-right">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="col-md-12">
                        ...
                        <form action="{{route('admin/town/delete')}}" method="post" role="form" id="delForm" style="display: none">
                            {{ csrf_field() }}
...
@section('script')
    <script>
        ...
        function submitForm() {
            ...
            mySwal('@lang('sidebar.town')', text, '@lang('confirm.no')', '@lang('confirm.yes')', '#townForm');
        }
